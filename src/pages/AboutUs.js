        ...
        <div className="mx-auto mt-7 w-full max-w-6xl lg:mt-14">
          <main className="my-14 lg:mt-24">
            ...
            <section className="relative">
              ...
              Welcome to IIITDMJ, a pioneering institution committed to transforming the educational landscape.{" "}
                <span className="text-blue-400">
                We inspire students to excel and cultivate the leaders of tomorrow.
                </span>{" "}
              </h1>
            ...
            <section className="mt-12 flex flex-col justify-between gap-10 lg:mt-24 lg:flex-row lg:gap-4">
              ...
              <div className="w-full space-y-8 lg:max-w-3xl lg:pl-4 lg:text-lg">
                ...
                <p>
                In doing so the Institute shall identify current and future agendas for scholarship, share knowledge and discoveries with the world community and actively cultivate individuals with the desire and capability to contribute to society.{" "}
                  {/* <Link href="#" className="text-blue-700 font-bold">
                    {" "}
                    G-campus
                  </Link>{" "} */}
            ...
            <section className="relative mt-12 flex flex-col justify-between gap-12 lg:mt-24 lg:flex-row lg:gap-4">
              ...
              <div className="z-10 w-full lg:max-w-3xl lg:pl-4 lg:text-lg">
                ...
                <p className="mt-8 lg:mt-12">
                  ...
                  In planning for its future as well as for conducting its ongoing activities, the Institute seeks to act in a manner that is guided by a deep-rooted sense of shared values and aspirations. Built upon such a foundation, the Institute:
                </p>
                <p className="mt-8">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-9">
                    ...
                    <div className="lg:pl-[100px] flex items-center">
                      <div className="data w-full">
                        ...
                        Welcome to IIITDM Jabalpur, where innovation meets creativity, and passion drives exceptional user experiences. At our institution, we've meticulously crafted Pagedone to empower creators, designers, and developers alike. Our mission? To provide you with a comprehensive toolkit that enables you to build intuitive, beautiful interfaces that resonate with users at every interaction. Join us in our journey to redefine the art of digital creation.
                        </p>
                      </div>
                    </div>
                  </div>
