...
function Footer({ NavLink, MoreOptionToggle, setMoreOptionToggle }) {
  ...
  return (
    <footer className=" text-gray-500 bg-gray-100 body-font">
      <hr className=" px-4" />
      ...
      <div style={{display:"none"}} className="bg-gray-200 min-h-[10vh] overflow-hidden flex justify-center items-center">
