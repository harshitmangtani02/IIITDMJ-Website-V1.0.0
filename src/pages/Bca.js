  ...
  return (
        ...
        <div className="mx-auto mt-7 w-full max-w-6xl lg:mt-14">
          <main className="my-14 lg:mt-20">
            <div className="flex justify-between items-center ">
              <span></span>
              <div style={{textAlign:'center'}}><h1  className=" text-lg text-center underline underline-offset-2 font-bold leading-tight tracking-tight text-heading  lg:text-3xl">
                      ...
                      <div className="max-w-xl text-center lg:text-left">
                        <div>
                          ...
                          <p className="max-w-xl text-lg mt-4  tracking-tight text-gray-600">
                            Bachelor of Technology is a popular course
                            ...
                            pursuing a career in IT, then a B-Tech course is a
    ...
    <li>
      <a href="#" className="text-blue-600 hover:underline">
        Computer Science Engeneering (CSE)
      </a>
    </li>
    <li>
      <a href="#" className="text-blue-600 hover:underline">
      Electronics & Communication Engeneering (ECE)
      </a>
    </li>
    <li>
      <a href="#" className="text-blue-600 hover:underline">
      Mechanical Engeneering (ME)
      </a>
    </li>
    <li>
      <a href="#" className="text-blue-600 hover:underline">
                        ...
                        <div className="max-w-xl">
                          <div>
                            <p className="text-xl font-medium tracking-tight text-blue-500 sm:text-3xl">
                              "Unlock Your Future with B-Tech: Igniting the Spark
                        ...
                        <div className="mx-auto mt-6 lg:max-w-7xl">
                          ...
                          >
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-base text-gray-500">
                                B-Tech empowers you to be a catalyst for
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-base text-gray-500">
                                ...
                                begins. B-Tech opens doors to a plethora of career
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-base text-gray-500">
                                More than an academic pursuit, B-Tech is where your
                    ...
                    <div className="mx-auto lg:max-w-7xl">
                      ...
                      >
                        ...
                        <li>
                          ...
                          <div className="mt-2 text-base text-gray-500">
                            Our B-Tech faculty is a symphony of expertise, with
                      ...
                      >
                        <li>
                          ...
                          <div className="mt-2 text-base text-gray-500">
                            ...
                            companies,our B-Tech graduates are on from the moment
